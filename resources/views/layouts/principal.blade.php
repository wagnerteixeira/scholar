	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a href="contato"><div class="cnt"><i class="contact"></i><i class="contact1"></i></div></a></li>
					<li><a class="active" href="/"><div class="bk"><i class="booking"></i><i class="booking1"></i></div></a></li>
				</ul>
			</div>
		<div class="main">
